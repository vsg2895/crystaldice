        ...
        {pageCount > 1 && (
          <div className="flex items-center gap-2">
            <button
              ...
              className="grid h-11 w-11 shrink-0 place-items-center rounded-full border border-zinc-200 text-zinc-600 transition-colors hover:border-indigo-300 hover:text-indigo-700 disabled:opacity-40 disabled:hover:border-zinc-200 disabled:hover:text-zinc-600"
            >
              ←
            </button>
        ...
        {visible.map((offer) => {
          ...
          return (
            <Link
              ...
              className="group flex gap-4 rounded-xl border border-zinc-200 bg-white p-4 transition-colors hover:border-indigo-300 hover:bg-indigo-50/40"
            >
              {thumb && (
                <Image
                  src={thumb}
