        ...
        {pageCount > 1 && (
          <div className="flex items-center gap-2">
            <button
              ...
              className="grid h-8 w-8 place-items-center rounded-full border border-zinc-200 text-zinc-600 transition-colors hover:border-indigo-300 hover:text-indigo-700 disabled:opacity-40 disabled:hover:border-zinc-200 disabled:hover:text-zinc-600"
            >
              ←
            </button>
