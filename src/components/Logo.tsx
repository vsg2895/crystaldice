...
export default function Logo({ className = '' }: { className?: string }) {
  return (
    <Link
      ...
      className={`inline-flex min-h-11 shrink-0 items-center rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 ${className}`.trim()}
    >
      <svg
        viewBox="0 0 680 260"
