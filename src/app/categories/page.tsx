      ...
      <div className="container mx-auto max-w-5xl">
        ...
        {categories.length === 0 ? (
          ...
          <ul className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
            {categories.map((c) => (
              <li key={c.id}>
                <Link href={`/categories/${c.slug}`} className="block rounded-2xl border border-zinc-100 bg-white p-6 text-center font-bold text-zinc-800 shadow-sm hover:border-indigo-300 hover:text-indigo-600 transition-colors">
