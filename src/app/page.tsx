        ...
        <section className="px-4 pb-20" aria-labelledby="top-casinos-heading">
          <div className="container mx-auto max-w-6xl">
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              ...
              {selected && (
                <Link href={`/categories/${selected}`} className="inline-block py-1 -my-1 text-sm font-semibold text-indigo-600 hover:text-indigo-700 whitespace-nowrap">{COPY.home.viewAll} →</Link>
              )}
            </div>
          ...
          <section className="border-t border-slate-200/70 bg-white/40 px-4 py-20" aria-labelledby="offers-heading">
            <div className="container mx-auto max-w-6xl">
              <div className="mb-10 flex items-end justify-between gap-4">
                ...
                <Link href="/special-offers" className="hidden py-1 -my-1 text-sm font-semibold text-indigo-600 hover:text-indigo-700 sm:block whitespace-nowrap">{COPY.home.viewAll} →</Link>
              </div>
